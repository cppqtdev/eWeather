...
ApplicationWindow {
    ...
    QtObject {
        ...
        readonly property string weatherApiUrl : "http://api.openweathermap.org/data/2.5/weather?"; //From https://openweathermap.org
        readonly property string apiKey : "527024843b1ff5e045e567c17ec5172c";
    ...
    function weatherRequest()
    {
        ...
        var theurl= appObject.weatherApiUrl + "lat="+appObject.lat+"&lon="+appObject.lon+"&units=" + unit + "&exclude=hourly,daily&appid=" + appObject.apiKey
        req.open(appObject.method,theurl);
        req.onreadystatechange = function() {
            if (req.readyState === XMLHttpRequest.DONE) {
        ...
        ColumnLayout {
            ...
            RowLayout{
                ...
                Text {
                    ...
                    text: '<html><style type="text/css"></style>Created by <strong><a href="https://github.com/cppqtdev">TechCoderHub</a></strong>, With QT QML </html>'
                }
            }
        }
    }
